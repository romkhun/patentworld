...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: 'IBM holds the largest US patent portfolio over the 1976-2025 period, followed by Samsung and Canon. The top 10 assignees collectively account for a substantial share of all US patent grants. Foreign-headquartered assignees surpassed US-based assignees in annual grant volume around 2007.',
  },
  {
    question: 'How long does it take to get a US patent?',
  ...
  },
  {
    ...
    answer: 'Female inventor representation on US patents has risen steadily but remains below 15% of all inventor instances. Average patent team size has approximately doubled from 1.8 to 3.5 inventors over the study period, but the gender composition of these teams has changed slowly.',
  },
  {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-4 text-muted-foreground">
        Common questions about US patent data, trends, and the PatentWorld project, answered with findings from analysis of {HERO_STATS.totalPatents} US patents (1976-2025).
      </p>
