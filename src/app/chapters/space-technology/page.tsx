...
export default function Chapter22() {
  ...
  return (
    <div>
      ...
      <InsightRecap
        learned={["Space technology top-four concentration fluctuated between 4.9% and 36.7%, reflecting the government-to-commercial transition.", "Satellite communications now dominates space technology patenting, with Boeing, ViaSat, and Hughes Network Systems as leading filers."]}
