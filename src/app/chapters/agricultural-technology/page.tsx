...
export default function Chapter12() {
  ...
  return (
    <div>
      ...
      <InsightRecap
        learned={["Agricultural technology patent velocity more than quadrupled from 7.4 patents per year (1970s entrants) to 32.9 (2000s entrants), coinciding with the precision agriculture revolution.", "Top-four concentration declined from 46.7% in 2014 to 32.8% by 2025 (through September), consistent with broader entry into agricultural innovation."]}
