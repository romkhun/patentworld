...
export default function Chapter19() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      <RelatedChapters currentChapter={40} />
      <ChapterNavigation currentChapter={40} />
    </div>
  );
}
