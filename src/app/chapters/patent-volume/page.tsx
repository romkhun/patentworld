...
import type { PatentsPerYear, ClaimsPerYear, HeroStats, DesignPatentTrend } from '@/lib/types';
...
export default function PatentVolumeChapter() {
  ...
  return (
    <div>
      <ChapterHeader
        ...
        subtitle="Growth, types, and complexity of US patent grants over five decades"
      />
      ...
      <Narrative>
        ...
        <p>
          ...
          number of individuals and <Link href="/chapters/assignee-landscape" className="underline decoration-muted-foreground/50 hover:decoration-foreground transition-colors">organizations</Link> are seeking patent protection as
      ...
      <Narrative>
        Having examined the overall scale, composition, and complexity of US patent activity over five decades, the next chapter explores the <Link href="/chapters/patent-process" className="underline decoration-muted-foreground/50 hover:decoration-foreground transition-colors">patent examination process and the role of government funding</Link> in shaping the innovation landscape.
        The fivefold expansion in patent output has placed sustained pressure on examination timelines and coincided with a significant increase in publicly funded patenting.
      </Narrative>
