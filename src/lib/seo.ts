...
const CHAPTER_SEO_DESCRIPTIONS: Record<string, string> = {
  ...
  'the-geography-of-innovation': 'California, New York, and Texas produce 40% of US patents. Explore geographic concentration, innovation hubs, and international assignee origins.',
  ...
  'patent-quality': 'Median forward citations fell 40% as patent volume surged. Explore patent quality metrics including originality, generality, and citation impact over 50 years.',
